...
import marius.destropho.uwu.utils.misc.BPlusEntityUtils;
...
public class CevBreaker extends Module {
    ...
    public CevBreaker() {
        super(UWU.CATEGORY1, "cev-breaker", "Automatically places an obsidian block and a crystal on top of the target and breaks the obby and crystal to deal massive damage.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        cwystalAuwa BBomber = Modules.get().get(cwystalAuwa.class);
